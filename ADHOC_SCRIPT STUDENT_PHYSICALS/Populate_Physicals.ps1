...
$counter = 1
$fileA = "C:\Temp\STUDENT_PHYSICALS.txt"
...
if ($counter -gt 1) {
	...
	#PROD
$Cmd.CommandText = "INSERT INTO rev.EPC_STU_HEALTH_SCR_ACT (STU_HEALTH_SCR_ACT_GU, STUDENT_GU,SCREEN_DATE,SCREEN_TYPE, RESULT) VALUES (`'$guid`',(select student_gu from rev.epc_stu where sis_number = `'$sisnum`'),`'$scrndate`',`'$scrntype`',`'$result`')"
